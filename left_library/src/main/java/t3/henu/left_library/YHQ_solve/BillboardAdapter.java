...
public class BillboardAdapter extends RecyclerView.Adapter<BillboardAdapter.ViewHolder> {
    ...
    @Override
    public BillboardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final BillboardAdapter.ViewHolder holder, int position) {
    ...
    private void setData(BillboardListInfo billboardListInfo, final BillboardAdapter.ViewHolder holder) {
